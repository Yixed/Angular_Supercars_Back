...
mongoose.connect(MONGO_URI, { useNewUrlParser: true, useUnifiedTopology: true })
  ...
  const users = [
    ...
    { _id: new mongoose.Types.ObjectId(), name: "floren", email: "floren@gmail.com", password: "florentino", role: "user" }
];
...
const vehicles = [
    ...
    { _id: new mongoose.Types.ObjectId(), brand: "Ford", model: "Fiesta", year: 2003, description: "Handy compact, low powered but strongly enjoyable.", image: "https://avatars.githubusercontent.com/u/159648656?v=4", pricePerDay: 180, available: true }
];
